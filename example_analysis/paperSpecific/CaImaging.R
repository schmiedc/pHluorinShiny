...
# ============================================================================
#
#  DESCRIPTION: Analyse Manual vs Automatic from processed results for Calcium 
#               imaging data
#              
...
indir = "/data1/FMP_Docs/Projects/Publication_SynActJ/DataAnalysis/ca_imaging/revised_output/"

# where to save the data
outdir = "/data1/FMP_Docs/Projects/Publication_SynActJ/DataAnalysis/ca_imaging/Routput/"
...
table.signal_manual_avg <- table.signal_manual_long %>% group_by(X1) %>% dplyr::summarize(mean=mean(value), N = length(value), sd = sd(value), se = sd / sqrt(N))
